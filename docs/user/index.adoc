...
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[lines=52..83]
----
...
<13> If you wish to use disk storage (like for persistent `Cache` instances), you'll have to register a
