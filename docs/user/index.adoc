...
[source,java,indent=0]
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[tag=defaultSerializers]
----
...
[source,java,indent=0]
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[tag=cacheSerializers]
----
