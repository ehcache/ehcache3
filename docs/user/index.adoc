...
[source,java,indent=0]
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[tag=userManagedCacheExample]
----
...
[source,java,indent=0]
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[tag=writeThroughCache]
----
...
[source,java,indent=0]
----
include::../../impl/src/test/java/org/ehcache/GettingStarted.java[tag=writeBehindCache]
----
...
<5> Enable the write coalescing behavior, which ensures that only latest update on a key hits the
    underlying resource  .
<6> Enable write-behind queue to batch the updates to underlying resource.
