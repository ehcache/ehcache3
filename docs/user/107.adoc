...
----
include::../../107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationTest.java[tag=mutableConfigurationExample]
----
...
[source,java,indent=0]
----
include::../../107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationTest.java[tag=ehcacheBasedConfigurationExample]
----
