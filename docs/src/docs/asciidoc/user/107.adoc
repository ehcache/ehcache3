...
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=basicConfigurationExample]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=mutableConfigurationExample]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=ehcacheCacheManagerConfigurationExample]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=ehcacheBasedConfigurationExample]
----
...
----
include::{sourcedir33}/107/src/test/resources/org/ehcache/docs/ehcache-jsr107-config.xml[]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=jsr107UsingXMLConfigExample]
----
...
[source%nowrap,xml,indent=0]
----
include::{sourcedir33}/107/src/test/resources/org/ehcache/docs/ehcache-107-mbeans-cache-manager-config.xml[lines=17..-1]
----
...
[source%nowrap,xml,indent=0]
----
include::{sourcedir33}/107/src/test/resources/org/ehcache/docs/ehcache-jsr107-template-override.xml[]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir33}/107/src/test/java/org/ehcache/docs/EhCache107ConfigurationIntegrationDocTest.java[tag=jsr107SupplementWithTemplatesExample]
----
...
[source%nowrap,xml,indent=0]
----
include::{sourcedir33}/107/src/test/resources/org/ehcache/docs/ehcache-jsr107-cache-through.xml[tag=cacheThroughCAS]
----
