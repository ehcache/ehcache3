...
----
<1> Create an Ehcache `CacheConfiguration` - through a builder as shown here or or alternatively use an XML configuration (as described in the following section).
