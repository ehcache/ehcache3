...
There is nothing special for you to do to use Ehcache 3 as the caching provider for your application: add the
`ehcache-3.1.0.jar`
to your application's classpath (possibly removing the previous provider's jar) and you are ready to go:
