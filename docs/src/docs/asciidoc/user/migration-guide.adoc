...
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/Ehcache2.java[tag=CustomExpiryEhcache2]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/Ehcache3.java[tag=CustomExpiryEhcache3]
----
