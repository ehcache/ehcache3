...
----
include::{sourcedir35}/xml/src/test/java/org/ehcache/docs/GettingStarted.java[tag=xmlConfig]
----
...
[source,xml,indent=0]
----
include::{sourcedir35}/xml/src/test/resources/configs/docs/template-sample.xml[tag=templateSample]
----
...
[source,java,indent=0]
----
include::{sourcedir35}/xml/src/test/java/org/ehcache/docs/GettingStarted.java[tag=xmlTemplate]
----
...
[source,java,indent=0]
----
include::{sourcedir35}/xml/src/test/java/org/ehcache/docs/GettingStarted.java[tag=xmlTranslation]
----
