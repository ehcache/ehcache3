...
----
include::{sourcedir32}/xml/src/test/java/org/ehcache/docs/GettingStarted.java[tag=xmlConfig]
----
...
[source,xml,indent=0]
----
include::{sourcedir32}/xml/src/test/resources/configs/docs/template-sample.xml[tag=templateSample]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/xml/src/test/java/org/ehcache/docs/GettingStarted.java[tag=xmlTemplate]
----
