...
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=cacheEventListener]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=registerListenerAtRuntime]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=configuringEventProcessingQueues]
----
