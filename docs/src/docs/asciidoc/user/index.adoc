...
|link:caching-terms.html[Caching Terms]|Learn terms and concepts that relate to caching
...
|link:eviction-veto.html[Eviction Vetoing]|Affecting the way entries are chosen for eviction
|===
