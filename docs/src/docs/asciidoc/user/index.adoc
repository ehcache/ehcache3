...
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=cachemanagerExample]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=userManagedCacheExample]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=offheapCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=persistentCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=updateResourcesAtRuntime]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=writeThroughCache]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=writeBehindCache]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=defaultSerializers]
----
...
[source,java,indent=0]
----
include::{sourcedir}/impl/src/test/java/org/ehcache/GettingStarted.java[tag=cacheSerializers]
----
