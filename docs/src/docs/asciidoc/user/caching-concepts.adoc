...
=== Storage Tiers
[[storage-tiers]]You can configure Ehcache to use various data storage areas.  When a cache is configured to use more than one data
...
the "hottest" (most recently accessed) data is kept in the faster (and typically less abundant) tiers, and data that
