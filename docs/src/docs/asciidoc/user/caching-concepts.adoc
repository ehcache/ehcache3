...
is less hot is confined to the slower (and more abundant) tiers.
...
server providing improved high availability. Since clustered storage comes with performance penalties due to such
