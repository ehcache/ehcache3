...
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=offheapOnly]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/clustered/client/src/test/java/org/ehcache/clustered/client/docs/Tiering.java[tag=clusteredOnly]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=diskPersistent]
----
