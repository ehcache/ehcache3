...
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=offheapOnly]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=heap]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=byteSizedTieredCache]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=offheap]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=persistentCacheManager]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=diskSegments]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/clustered/client/src/test/java/org/ehcache/clustered/client/docs/Tiering.java[tag=threeTiersCacheManager]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=threeTiersCacheManager]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=notShared]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/Tiering.java[tag=updateResourcesAtRuntime]
----
