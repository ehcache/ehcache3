...
NOTE: Ehcache clustering is not yet compatible with _cache-through_.
...
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=writeThroughCache]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=writeBehindCache]
----
