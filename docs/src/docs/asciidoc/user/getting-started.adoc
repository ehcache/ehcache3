...
Remember that data stored off-heap will have to be serialized and deserialized.
...
`java.lang.Integer`, `java.lang.Double`, `java.lang.Float`, `java.lang.Character` and `byte[]`.
