...
= Getting started with Ehcache 3.0
...
We feel that the Ehcache 3.0 API is a great improvement over the Ehcache 2.x API that has been used by
...
You can perform all configuration programmatically.  (See further below for configuring with XML).
