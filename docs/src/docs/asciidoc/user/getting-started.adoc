...
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=cachemanagerExample]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/UserManagedCaches.java[tag=userManagedCacheExample]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=offheapCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=persistentCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=threeTiersCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=byteSizedTieredCache]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=updateResourcesAtRuntime]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=expiry]
----
...
[source,xml]
----
include::{sourcedir33}/xml/src/test/resources/configs/docs/getting-started.xml[tags=gettingStarted]
----
