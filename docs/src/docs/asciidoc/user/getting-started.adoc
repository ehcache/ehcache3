...
=== Creating cache manager with clustering support
...
For developer information, you might want to go check the https://github.com/ehcache/ehcache3/wiki[Ehcache 3 project wiki on GitHub].
