...
constructors in his serializer implementation, the usage of these arguments is upto the user. The user can decide to
completely ignore these parameters. But the presence of these constructors is a strict requirement.
