...
----
include::{sourcedir34}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=cachemanagerExample]
----
...
[source,java,indent=0]
----
include::{sourcedir34}/integration-test/src/test/java/org/ehcache/docs/GettingStartedWithStaticImports.java[tag=java7Example]
----
...
[source,xml,indent=0]
----
include::{sourcedir34}/xml/src/test/resources/configs/docs/getting-started.xml[tags=gettingStarted]
----
...
[source,java,indent=0]
----
include::{sourcedir34}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=threeTiersCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir34}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=expiry]
----
