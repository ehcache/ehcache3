...
The latest version of Ehcache 3.11 has been released to maven central under the following coordinates:
...
Ehcache 3.10 added support for the Jakarta EE namespaced versions of the JAXB APIs.
...
----
include::{sourcedir311}/ehcache-impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=cachemanagerExample]
----
...
[source,java,indent=0]
----
include::{sourcedir311}/integration-test/src/test/java/org/ehcache/docs/GettingStartedWithStaticImports.java[tag=java7Example]
----
...
[source,xml,indent=0]
----
include::{sourcedir311}/ehcache-xml/src/test/resources/configs/docs/getting-started.xml[tags=gettingStarted]
----
...
[source,java,indent=0]
----
include::{sourcedir311}/ehcache-impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=threeTiersCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir311}/ehcache-impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=expiry]
----
