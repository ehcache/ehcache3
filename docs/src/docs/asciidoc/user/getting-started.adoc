...
version: 3.6
---
= Ehcache {{page.version}} Documentation
ifndef::sourcedir36[]
include::common.adoc[]
endif::sourcedir36[]
...
----
include::{sourcedir36}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=cachemanagerExample]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/integration-test/src/test/java/org/ehcache/docs/GettingStartedWithStaticImports.java[tag=java7Example]
----
...
[source,xml,indent=0]
----
include::{sourcedir36}/xml/src/test/resources/configs/docs/getting-started.xml[tags=gettingStarted]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=threeTiersCacheManager]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=expiry]
----
