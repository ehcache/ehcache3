...
Java configuration is most easily achieved through the use of builders that offer a straightforward API.
...
It also guards the `Cache` from being polluted by random types.
