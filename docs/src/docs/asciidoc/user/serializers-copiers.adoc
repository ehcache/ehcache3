...
----
include::{sourcedir33}/api/src/main/java/org/ehcache/spi/serialization/Serializer.java[lines=20..-1]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/api/src/main/java/org/ehcache/spi/copy/Copier.java[lines=19..-1]
----
