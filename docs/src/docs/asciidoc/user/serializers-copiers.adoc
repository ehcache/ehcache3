...
----
include::{sourcedir311}/ehcache-api/src/main/java/org/ehcache/spi/serialization/Serializer.java[lines=20..-1]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-api/src/main/java/org/ehcache/spi/copy/Copier.java[lines=19..-1]
----
