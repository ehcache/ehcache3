...
<2> If you want to hint the eviction algorithm to advisor against the eviction of some mappings, you have to
...
NOTE: Eviction advise status is computed when a mapping is written to the cache.
