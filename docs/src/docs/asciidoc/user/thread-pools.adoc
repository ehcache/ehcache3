...
[source%nowrap,java]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=diskStore]
----
...
[source%nowrap,java]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=writeBehind]
----
...
[source%nowrap,java]
----
include::{sourcedir35}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=events]
----
...
[source%nowrap,xml]
----
include::{sourcedir35}/xml/src/test/resources/configs/docs/thread-pools.xml[tags=threadPools]
----
