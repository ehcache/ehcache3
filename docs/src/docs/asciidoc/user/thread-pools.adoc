...
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=diskStore]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=writeBehind]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/ThreadPools.java[tag=events]
----
...
[source,xml]
----
include::{sourcedir32}/xml/src/test/resources/configs/docs/thread-pools.xml[tags=threadPools]
----
