...
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=deriveContract]
----
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=customClassLoader]
----

.adding a cache:
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=withCache]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=withoutCache]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=updateCache]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=withServiceCreation]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=updateServiceCreation]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/ehcache-impl/src/test/java/org/ehcache/docs/ConfigurationDerivation.java[tag=withService]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/clustered/ehcache-client/src/test/java/org/ehcache/clustered/client/docs/ConfigurationDerivation.java[tag=updateService]
----
[cols=".^~a,^.^~d,.^~a"]
|===
|[source,xml]
...
[source,java,indent=0]
----
include::{sourcedir39}/clustered/ehcache-client/src/test/java/org/ehcache/clustered/client/docs/ConfigurationDerivation.java[tag=removeService]
----
