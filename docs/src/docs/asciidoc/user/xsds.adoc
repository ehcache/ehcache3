...
** Location for 3.11: `http://www.ehcache.org/schema/ehcache-core-3.11.xsd`
// needle_for_core_xsd
...
** Location for 3.11: `http://www.ehcache.org/schema/ehcache-107-ext-3.11.xsd`
// needle_for_107_xsd
...
** Location for 3.11: `http://www.ehcache.org/schema/ehcache-tx-ext-3.11.xsd`
...
** Location for 3.11: `http://www.ehcache.org/schema/ehcache-clustered-ext-3.11.xsd`
...
[source,xml,indent=0]
----
include::{sourcedir311}/ehcache-107/src/test/resources/org/ehcache/docs/public-xsds-location.xml[tag=xsdLocations]
----
...
[source,xsd,indent=0]
----
include::{sourcedir311}/ehcache-xml/src/common/schema/ehcache-core.xsd[lines=18..-1]
----
...
[source,xsd,indent=0]
----
include::{sourcedir311}/ehcache-107/src/main/resources/ehcache-107-ext.xsd[lines=18..-1]
----
...
[source,xsd,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/common/resources/ehcache-tx-ext.xsd[lines=18..-1]
----
