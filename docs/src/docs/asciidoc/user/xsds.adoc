...
[source,xsd,indent=0]
----
include::{sourcedir310}/ehcache-xml/src/main/schema/ehcache-core.xsd[lines=18..-1]
----
...
[source,xsd,indent=0]
----
include::{sourcedir310}/ehcache-transactions/src/main/resources/ehcache-tx-ext.xsd[lines=18..-1]
----
