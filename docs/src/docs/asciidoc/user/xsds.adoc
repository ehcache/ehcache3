...
[source,xml,indent=0]
----
include::{sourcedir39}/ehcache-107/src/test/resources/org/ehcache/docs/public-xsds-location.xml[tag=xsdLocations]
----
...
[source,xsd,indent=0]
----
include::{sourcedir39}/ehcache-xml/src/common/schema/ehcache-core.xsd[lines=18..-1]
----
...
[source,xsd,indent=0]
----
include::{sourcedir39}/ehcache-107/src/main/resources/ehcache-107-ext.xsd[lines=18..-1]
----
...
[source,xsd,indent=0]
----
include::{sourcedir39}/ehcache-transactions/src/common/resources/ehcache-tx-ext.xsd[lines=18..-1]
----
