...
----
include::{sourcedir311}/ehcache-transactions/src/test/java/org/ehcache/docs/transactions/xa/XAGettingStarted.java[tag=testSimpleXACache]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/test/java/org/ehcache/docs/transactions/xa/XAGettingStarted.java[tag=testXACacheWithWriteThrough]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/test/java/org/ehcache/docs/transactions/xa/XAGettingStarted.java[tag=testNonTransactionalAccess]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/test/java/org/ehcache/docs/transactions/xa/XAGettingStarted.java[tag=testXACacheWithThreeTiers]
----
...
----
include::{sourcedir311}/ehcache-transactions/src/test/resources/docs/configs/xa-getting-started.xml[tags=gettingStarted]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/test/java/org/ehcache/docs/transactions/xa/XAGettingStarted.java[tag=testXACacheWithXMLConfig]
----
...
[source%nowrap,java,indent=0]
----
include::{sourcedir311}/ehcache-transactions/src/main/java/org/ehcache/transactions/xa/txmgr/btm/BitronixTransactionManagerLookup.java[tag=BitronixLookup]
----
