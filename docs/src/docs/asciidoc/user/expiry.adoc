...
[source,xml,indent=0]
----
include::{sourcedir32}/xml/src/test/resources/configs/docs/getting-started.xml[tags=expiry]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/api/src/main/java/org/ehcache/expiry/Expiry.java[lines=21..-1]
----
...
[source,java,indent=0]
----
include::{sourcedir32}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=customExpiry]
----
...
[source,xml,indent=0]
----
include::{sourcedir32}/xml/src/test/resources/configs/docs/getting-started.xml[tags=customExpiry]
----
