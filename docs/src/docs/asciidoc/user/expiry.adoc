...
[source,xml,indent=0]
----
include::{sourcedir311}/ehcache-xml/src/test/resources/configs/docs/expiry.xml[tags=expiry]
----
...
[source,java,indent=0]
----
include::{sourcedir311}/ehcache-api/src/main/java/org/ehcache/expiry/ExpiryPolicy.java[lines=21..-1]
----
...
[source,java,indent=0]
----
include::{sourcedir311}/ehcache-impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=customExpiry]
----
...
[source,xml,indent=0]
----
include::{sourcedir311}/ehcache-xml/src/test/resources/configs/docs/expiry.xml[tags=customExpiry]
----
