...
[source,xml,indent=0]
----
include::{sourcedir36}/xml/src/test/resources/configs/docs/expiry.xml[tags=expiry]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/api/src/main/java/org/ehcache/expiry/ExpiryPolicy.java[lines=21..-1]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/impl/src/test/java/org/ehcache/docs/GettingStarted.java[tag=customExpiry]
----
...
[source,xml,indent=0]
----
include::{sourcedir36}/xml/src/test/resources/configs/docs/expiry.xml[tags=customExpiry]
----
