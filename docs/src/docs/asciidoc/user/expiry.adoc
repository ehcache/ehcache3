...
[source,xml,indent=0]
----
include::{sourcedir33}/xml/src/test/resources/configs/docs/expiry.xml[tags=expiry]
----
...
[source,xml,indent=0]
----
include::{sourcedir33}/xml/src/test/resources/configs/docs/expiry.xml[tags=customExpiry]
----
