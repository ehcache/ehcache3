...
This table describes the impact of each cache method on the statistics. It is compatible with
...
|clear          |No |No  |No |No    |No     |
|containsKey    |No |No  |No |No    |No     |
|forEach        |Yes|Yes |No |No    |No     |Java 8
|get            |Yes|Yes |No |No    |No     |
|getAll         |Yes|Yes |No |No    |No     |
|getAndPut      |Yes|Yes |Yes|Yes   |No     |JSR107 specific
|getAndRemove   |Yes|Yes |No |No    |Yes    |JSR107 specific
|getAndReplace  |Yes|Yes |Yes|Yes   |No     |JSR107 specific
|invoke         |Yes|Yes |Yes|Yes   |Yes    |JSR107 specific
|invokeAll      |Yes|Yes |Yes|Yes   |Yes    |JSR107 specific
|iterator       |Yes|Yes |No |No    |Yes    |
|loadAll        |No |No  |No |No    |No     |JSR107 specific
|put            |No |No  |Yes|Yes   |No     |
|putAll         |No |No  |Yes|Yes   |No     |
|putIfAbsent    |Yes|Yes |Yes|Yes   |No     |
|remove(K)      |No |No  |No |No    |Yes    |
|remove(K,V)    |Yes|Yes |No |No    |Yes    |Hit is the key is found. Miss otherwise
|removeAll      |No |No  |No |No    |Yes    |
|removeAll(keys)|No |No  |No |No    |Yes    |
|replace(K,V)   |Yes|Yes |Yes|Yes   |No     |
|replace(K,O,N) |Yes|Yes |Yes|Yes   |No     |
|spliterator    |Yes|No  |No |No    |No     |Java 8
|====================================================================================
