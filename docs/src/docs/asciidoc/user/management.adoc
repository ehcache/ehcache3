...
----
include::{sourcedir36}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=usingManagementRegistry]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=capabilitiesAndContexts]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=actionCall]
----
...
[source,java,indent=0]
----
include::{sourcedir36}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=managingMultipleCacheManagers]
----
