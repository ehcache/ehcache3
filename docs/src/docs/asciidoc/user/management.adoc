...
----
include::{sourcedir33}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=usingManagementRegistry]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=capabilitiesAndContexts]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=actionCall]
----
...
[source,java,indent=0]
----
include::{sourcedir33}/management/src/test/java/org/ehcache/docs/ManagementTest.java[tag=managingMultipleCacheManagers]
----
...
|clear          |No |No  |No |No    |No     |No        |No      |A bulk remove with no impact on stats
...
|loadAll        |No |No  |No |No    |No     |No        |No      |JSR107 specific. Background loading that has no impact on stats
|put            |No |No  |Yes|Yes   |No     |No        |Yes     |Put an entry whether it already existed or not. Update if already existing
