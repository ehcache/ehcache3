...
import static org.ehcache.internal.store.offheap.AbstractOffHeapStoreTest.eventType;
...
public class FudgingInvocationScopedEventSinkTest {
  ...
  public void setUp() {
    ...
    eventSink = new FudgingInvocationScopedEventSink<String, String>(new HashSet<StoreEventFilter<String, String>>(),
