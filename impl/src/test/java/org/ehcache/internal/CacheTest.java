...
public class CacheTest {
  ...
  public void testHeapCache() throws CacheAccessException {
    ...
    Cache<String, String> cache = new TieredCache<String, String>(cachingTier,
        String.class, String.class, new ServiceLocator(heapResource), new HeapResourceCacheConfiguration(1000));
    cache.put("foo", "bar");
  ...
  public void testSerializingCache() throws CacheAccessException {
    ...
    final ServiceLocator serviceLocator = new ServiceLocator(serialization);
    final SerializingResource serializingResource = new SerializingResource(serviceLocator);
    final HeapResource heapResource = new HeapResource(serviceLocator);
    final Cache<String, String> cachingTier = serializingResource.createCache(String.class, String.class);
    Cache<String, String> cache = new TieredCache<String, String>(cachingTier, String.class, String.class, new ServiceLocator(heapResource), new HeapResourceCacheConfiguration(1000));
    cache.put("foo", "bar");
    assertThat(cache, hasEntry("foo", "bar"));
  }
  ...
  public void testSerializingCacheWithNonSerializableType() throws CacheAccessException {
    ...
    Cache<String, Serializable> cache = new TieredCache<String, Serializable>(cachingTier, String.class, Serializable.class, new ServiceLocator(heapResource), new HeapResourceCacheConfiguration(1000));
    try {
