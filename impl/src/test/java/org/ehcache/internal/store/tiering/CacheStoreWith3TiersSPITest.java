...
import org.ehcache.internal.store.offheap.OffHeapStoreSPITest;
  ...
  public void setUp() throws IOException {
    ...
    storeFactory = new StoreFactory<String, String>() {
      ...
      private Store<String, String> newStore(Long capacity, EvictionVeto<String, String> evictionVeto, Expiry<? super String, ? super String> expiry, TimeSource timeSource) {
        ...
        final OnHeapStore<String, String> onHeapStore = new OnHeapStore<String, String>(config, timeSource, defaultCopier, defaultCopier, new DefaultSizeOfEngine(0, 0));
