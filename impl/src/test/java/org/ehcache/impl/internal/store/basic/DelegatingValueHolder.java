...
/**
 * ValueHolder delegating everything to another ValueHolder.
 */
public class DelegatingValueHolder<T> implements Store.ValueHolder<T> {

  private final Store.ValueHolder<T> valueHolder;

  public DelegatingValueHolder(Store.ValueHolder<T> valueHolder) {
