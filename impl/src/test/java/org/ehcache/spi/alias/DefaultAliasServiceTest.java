...
public class DefaultAliasServiceTest {
  ...
  public void test_identification_service() throws Exception {
    assertThat(unNamedIdServ.getCacheManagerAlias(), startsWith("cache-manager-"));
    assertThat(namedIdServ.getCacheManagerAlias(), equalTo("my-cm"));
    assertThat(namedIdServ.getCacheAlias(namedCM.getCache("aCache1", String.class, String.class)), equalTo("aCache1"));

    Cache<String, String> cache3 = unnamedCM.getCache("aCache3", String.class, String.class);

    assertThat(unNamedIdServ.getCacheAlias(cache3), equalTo("aCache3"));
