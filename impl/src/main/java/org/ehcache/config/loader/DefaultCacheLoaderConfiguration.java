...
* @author Alex Snaps
*/
public class DefaultCacheLoaderConfiguration implements ServiceConfiguration<DefaultCacheLoaderFactory> {
  ...
  public <K, V> Class<CacheLoader<? extends K, ? extends V>> getClazz() {
    return clazz;
  }
