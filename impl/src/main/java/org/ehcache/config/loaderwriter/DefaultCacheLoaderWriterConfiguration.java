...
* @author Alex Snaps
*/
public class DefaultCacheLoaderWriterConfiguration extends ClassInstanceConfiguration<CacheLoaderWriter<?, ?>> implements ServiceUseConfiguration<CacheLoaderWriterProvider> {
