...
public class CacheEventNotificationServiceConfigurationBuilder implements Builder<CacheEventDispatcherConfiguration> {
  ...
  public DefaultCacheEventDispatcherConfiguration build() {
    return new DefaultCacheEventDispatcherConfiguration(numberOfEventProcessingQueues);
  }
}
