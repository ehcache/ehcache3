...
import org.ehcache.InternalRuntimeConfigurationImpl;
...
public class HeapCache<K, V> extends Ehcache<K, V> {
  ...
  public HeapCache(Logger logger) {
    this(new RuntimeConfiguration<K, V>(
            ...
            new InternalRuntimeConfigurationImpl<K, V>(
                new CacheConfiguration<K, V>() {
                  @Override
                  public Collection<ServiceConfiguration<?>> getServiceConfigurations() {
                    throw new UnsupportedOperationException("Implement me!");
  ...
  public HeapCache(RuntimeConfiguration<K, V> runtimeConfig, final Store<K, V> store, Logger logger) {
    super(runtimeConfig, store, logger);
  }
