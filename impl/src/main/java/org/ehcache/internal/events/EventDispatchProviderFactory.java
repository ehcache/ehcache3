...
public class EventDispatchProviderFactory implements ServiceFactory<EventDispatchProvider> {
  ...
  public EventDispatchProvider create(ServiceCreationConfiguration<EventDispatchProvider> configuration) {
    ...
    } else if (configuration instanceof EventDispatcherFactoryConfiguration) {
      return new EventDispatchProviderImpl((EventDispatcherFactoryConfiguration) configuration);
    } else {
      throw new IllegalArgumentException("Expected a configuration of type EventDispatcherFactoryConfiguration but got "
