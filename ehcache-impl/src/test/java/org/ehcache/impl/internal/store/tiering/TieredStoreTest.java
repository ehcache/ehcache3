...
public class TieredStoreTest {
  ...
  public void testReleaseStoreFlushes() throws Exception {
    ...
    when(onHeapStoreProvider.rank(eq(cachingResources), any(Collection.class))).thenReturn(1);
    ...
    when(offHeapStoreProvider.rank(eq(authorityResources), any(Collection.class))).thenReturn(1);
  ...
  public void testGetAuthoritativeTierProvider() {
    ...
    when(provider1.rank(any(Set.class), any())).thenReturn(1);
    AuthoritativeTier.Provider provider2 = mock(AuthoritativeTier.Provider.class);
    when(provider2.rank(any(Set.class), any())).thenReturn(2);
