...
class Eh107Cache<K, V> implements Cache<K, V> {
  ...
  Eh107Cache(String name, Eh107Configuration<K, V> config, CacheResources<K, V> cacheResources,
      org.ehcache.Cache<K, V> ehCache, Eh107CacheManager cacheManager, ManagementRegistry managementRegistry, AliasService aliasService) {
    ...
    this.statisticsBean = new Eh107CacheStatisticsMXBean(name, cacheManager, ehCache, managementRegistry, aliasService);
