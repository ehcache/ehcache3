...
public class ResourceCombinationsTest {
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
      ...
      //not supported
      //{ newResourcePoolsBuilder().offheap(5, MB).disk(10, MB) },
  ...
  @Test
  public void testBasicCacheOperation() throws IOException {
    Configuration config = new DefaultConfiguration(
            ResourceCombinationsTest.class.getClassLoader(),
            new DefaultPersistenceConfiguration(diskPath.newFolder()));

    CacheManager cacheManager = new EhcacheCachingProvider().getCacheManager(URI.create("foobar"), config);
    try {
