...
public class MandatoryHighRankServiceBFactory implements ServiceFactory<RankServiceB> {
  ...
  @Override
  public Class<? extends RankServiceB> getServiceType() {
    return RankServiceB.class;
  }
}
