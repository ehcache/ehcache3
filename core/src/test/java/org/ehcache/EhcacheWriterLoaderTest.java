...
public class EhcacheWriterLoaderTest {
  ...
  public void testPut() throws Exception {
    when(store.compute(any(Number.class), any(BiFunction.class))).thenAnswer(new Answer<Object>() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
        BiFunction<Number, String, String> function = (BiFunction)invocation.getArguments()[1];
  ...
  public void testPutThrowsOnCompute() throws Exception {
    when(store.compute(any(Number.class), any(BiFunction.class))).thenThrow(new CacheAccessException("boom"));
    cache.put(1, "one");
  ...
  public void testRemove() throws Exception {
    when(store.computeIfPresent(any(Number.class), any(BiFunction.class))).thenAnswer(new Answer<Object>() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
        BiFunction<Number, String, String> function = (BiFunction)invocation.getArguments()[1];
        function.apply((Number)invocation.getArguments()[0], null);
  ...
  public void testRemoveThrowsOnCompute() throws Exception {
    when(store.computeIfPresent(any(Number.class), any(BiFunction.class))).thenThrow(new CacheAccessException("boom"));
    cache.remove(1);
    verify(store).remove(1);
    verify(cache.getCacheWriter()).delete(1);
  }
  ...
  public void testPutIfAbsent() throws Exception {
    when(store.computeIfAbsent(any(Number.class), any(Function.class))).thenAnswer(new Answer<Object>() {
      @Override
      public Object answer(InvocationOnMock invocation) throws Throwable {
        Function<Number, String> function = (Function)invocation.getArguments()[1];
  ...
  public void testPutIfAbsentThrowsOnCompute() throws Exception {
    when(store.computeIfAbsent(any(Number.class), any(Function.class))).thenThrow(new CacheAccessException("boom"));
