...
public class EhcacheBasicGetAllTest extends EhcacheBasicCrudBase {
  ...
  public void testGetAllStoreNoMatchLoaderAllFailWithBulkCacheLoadingException() throws Exception {
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(TEST_ENTRIES, true);
    this.loaderWriter = spy(fakeLoader);
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws before accessing loader</li>
   *    <li>with a {@code CacheLoaderWriter} (loader-provided entries not relevant)</li>
   *    <li>all {@link CacheLoaderWriter#loadAll(Iterable)} calls fail with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreNoMatchCacheAccessExceptionBeforeLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws before accessing loader</li>
   *    <li>with a {@code CacheLoaderWriter} (loader-provided entries not relevant)</li>
   *    <li>some {@link CacheLoaderWriter#loadAll(Iterable)} calls fail with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreNoMatchCacheAccessExceptionBeforeLoaderSomeFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
    ...
    assertThat(this.bulkExceptionCaptor.getValue().getSuccesses().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_C));
    assertThat(this.bulkExceptionCaptor.getValue().getFailures().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_A));
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws after accessing loader</li>
   *    <li>with a {@code CacheLoaderWriter} (loader-provided entries not relevant)</li>
   *    <li>all {@link CacheLoaderWriter#loadAll(Iterable)} calls fails with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreNoMatchCacheAccessExceptionAfterLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws after accessing loader</li>
   *    <li>with a {@code CacheLoaderWriter} (loader-provided entries not relevant)</li>
   *    <li>some {@link CacheLoaderWriter#loadAll(Iterable)} calls fails with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreNoMatchCacheAccessExceptionAfterLoaderSomeFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchLoaderSomeFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionBeforeLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionBeforeLoaderLSomeFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
    ...
    ordered.verify(this.spiedResilienceStrategy)
        .getAllFailure(eq(fetchKeys), any(CacheAccessException.class), this.bulkExceptionCaptor.capture());
    assertThat(this.bulkExceptionCaptor.getValue().getSuccesses().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_D));
    assertThat(this.bulkExceptionCaptor.getValue().getFailures().keySet(), Matchers.<Set<?>>equalTo(union(KEY_SET_A, KEY_SET_C)));
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionAfterLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionAfterLoaderSomeFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);
  ...
  public void testGetAllStoreSomeMatchLoaderNoMatchSomeFailWithBulkCacheLoadingException() throws Exception {
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(getEntryMap(KEY_SET_F), KEY_SET_C, true);
    this.loaderWriter = spy(fakeLoader);
    ...
    try {
      ...
      // Expected
      assertThat(e.getSuccesses(), Matchers.<Map<?,?>>equalTo(union(getEntryMap(KEY_SET_A), 
                                                                     getNullEntryMap(KEY_SET_C))));
      assertThat(e.getFailures().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_D));
    }
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionBeforeLoaderNoMatchAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(getEntryMap(KEY_SET_F), true);
    this.loaderWriter = spy(fakeLoader);
   ...
   *    <li>some {@link Store} entries match</li>
   *    <li>some {@link CacheLoaderWriter} entries match</li>
   *    <li>non-matching {@link CacheLoaderWriter#loadAll(Iterable)} calls fails with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreSomeMatchLoaderSomeMatchDisjointFailWithBulkCacheLoadingException() throws Exception {
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(getEntryMap(KEY_SET_E, KEY_SET_E), 
                                                                        KEY_SET_C, true);
    this.loaderWriter = spy(fakeLoader);
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws before accessing loader</li>
   *    <li>some {@link CacheLoaderWriter} entries match</li>
   *    <li>non-matching {@link CacheLoaderWriter#loadAll(Iterable)} calls fail with 
   *        {@link BulkCacheLoadingException}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionBeforeLoaderSomeMatchDisjointFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B));
    this.store = spy(fakeStore);
    doThrow(new CacheAccessException("")).when(this.store)
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(getEntryMap(KEY_SET_E), KEY_SET_E, true);
    this.loaderWriter = spy(fakeLoader);
    ...
    assertThat(this.bulkExceptionCaptor.getValue().getFailures().keySet(), 
                Matchers.<Set<?>>equalTo(union(KEY_SET_A, KEY_SET_C)));
   ...
   */
  @Test
  public void testGetAllStoreSomeMatchCacheAccessExceptionAfterLoaderSomeMatchDisjointFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);

    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(
                                                   getEntryMap(KEY_SET_A, KEY_SET_B, KEY_SET_C, KEY_SET_E),
                                                   union(union(KEY_SET_A, KEY_SET_B), union(KEY_SET_C, KEY_SET_E)), true);
    this.loaderWriter = spy(fakeLoader);
    ...
    try {
      ...
      // Expected
      assertThat(e.getSuccesses(),
                 Matchers.<Map<?,?>>equalTo(union(getNullEntryMap(KEY_SET_A), getNullEntryMap(KEY_SET_C))));
      assertThat(e.getFailures().keySet(), Matchers.<Set<?>>equalTo(union(KEY_SET_D, KEY_SET_F)));
    }
  ...
  public void testGetAllStoreAllMatchCacheAccessExceptionBeforeLoaderSomeFailWithBulkCacheLoadingException() throws Exception {
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(TEST_ENTRIES, KEY_SET_B, true);
    this.loaderWriter = spy(fakeLoader);
    ...
    ordered.verify(this.spiedResilienceStrategy)
        .getAllFailure(eq(fetchKeys), any(CacheAccessException.class), this.bulkExceptionCaptor.capture());
    assertThat(this.bulkExceptionCaptor.getValue().getSuccesses().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_B));
    assertThat(this.bulkExceptionCaptor.getValue().getFailures().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_A));
   ...
   */
  @Test
  public void testGetAllStoreAllMatchCacheAccessExceptionAfterLoaderAllFailWithBulkCacheLoadingException() 
           throws Exception {
    final FakeStore fakeStore = new FakeStore(getEntryMap(KEY_SET_A, KEY_SET_B), Collections.singleton("keyA3"));
    this.store = spy(fakeStore);
  ...
  public void testGetAllStoreAllMatchCacheAccessExceptionBeforeLoaderNoMatchSomeFailWithBulkCacheLoadingException() throws Exception {
    ...
    final FakeCacheLoaderWriter fakeLoader = new FakeCacheLoaderWriter(getEntryMap(KEY_SET_C, KEY_SET_F), KEY_SET_F, true);
    this.loaderWriter = spy(fakeLoader);
   ...
   *    <li>{@link Store#bulkComputeIfAbsent} throws before accessing loader</li>
   *    <li>some {@link CacheLoaderWriter} entries match</li>
   *    <li>non-matching {@link CacheLoaderWriter#loadAll(Iterable)} calls fail witb
   *         {@link BulkCacheLoadingexception}</li>
   * </ul>
   */
  @Test
  public void testGetAllStoreAllMatchCacheAccessExceptionBeforeLoaderSomeMatchDisjointFailWithBulkCacheLoadingException() throws Exception {
    ...
    ordered.verify(this.spiedResilienceStrategy)
        .getAllFailure(eq(fetchKeys), any(CacheAccessException.class), this.bulkExceptionCaptor.capture());
    assertThat(this.bulkExceptionCaptor.getValue().getSuccesses(), 
                Matchers.<Map<?,?>>equalTo(getNullEntryMap(KEY_SET_B)));
    assertThat(this.bulkExceptionCaptor.getValue().getFailures().keySet(), Matchers.<Set<?>>equalTo(KEY_SET_A));
