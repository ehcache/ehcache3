...
class ThreadPoolServiceCreationConfigurationParser<T extends ServiceCreationConfiguration<?, ?>> extends SimpleCoreServiceCreationConfigurationParser<ConfigType, ThreadPoolReferenceType, T> {
