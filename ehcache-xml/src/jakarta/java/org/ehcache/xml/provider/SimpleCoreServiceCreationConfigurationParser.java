...
class SimpleCoreServiceCreationConfigurationParser<CONFIG, T, U extends ServiceCreationConfiguration<?, ?>> implements CoreServiceCreationConfigurationParser<CONFIG> {

  private final Class<U> configType;

  private final Function<CONFIG, T> getter;
  private final BiConsumer<CONFIG, T> setter;
  ...
  SimpleCoreServiceCreationConfigurationParser(Class<U> configType,
                                               Function<CONFIG, T> getter, BiConsumer<CONFIG, T> setter,
  ...
  SimpleCoreServiceCreationConfigurationParser(Class<U> configType, Function<CONFIG, T> getter, BiConsumer<CONFIG, T> setter,
