...
public class XmlMultiConfigurationTest {
  ...
  @Test
  public void testManagerRemovedFromXml() {
    URL resource = XmlConfigurationTest.class.getResource("/configs/multi/multiple-configs.xml");
  ...
  @Test
  public void testManagerRemovedFromXmlAndReadded() {
    URL resource = XmlConfigurationTest.class.getResource("/configs/multi/multiple-configs.xml");
  ...
  @Test
  public void testManagerAddedToXml() {
    URL resource = XmlConfigurationTest.class.getResource("/configs/multi/multiple-configs.xml");
  ...
  @Test
  public void testManagerRemovedFromConfigAndReadded() {
    XmlMultiConfiguration source = XmlMultiConfiguration.fromNothing().withManager("foo", emptyConfiguration()).build();
  ...
  @Test
  public void testManagerAddedToConfig() {
    XmlMultiConfiguration source = XmlMultiConfiguration.fromNothing().withManager("foo", emptyConfiguration()).build();
  ...
  @Test
  public void testGenerateExtendedConfiguration() {
