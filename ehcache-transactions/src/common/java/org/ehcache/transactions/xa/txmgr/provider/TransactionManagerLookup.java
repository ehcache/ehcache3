...
/**
 * Interface used by the {@code LookupTransactionManagerProvider} to lookup transaction managers to be used in XA
 * transactional caches.
 * <p>
 * Implementation are epxected to offer a no-arg constructor that will be used by Ehcache.
 */
public interface TransactionManagerLookup<TM> {
   ...
   */
  TransactionManagerWrapper<TM> lookupTransactionManagerWrapper();
}
