...
/**
 * The point of this test is to assert proper data read after fail-over handling with evictions in place.
 */
public class BasicClusteredCacheOpsReplicationWithMulitpleClientsTest {
  ...
  public void testCRUD() throws Exception {
    ...
    readKeysByCache2BeforeFailOver.stream().filter(x -> !readKeysByCache1AfterFailOver.contains(x)).forEach(y -> assertThat(CACHE2.get(y), nullValue()));
