...
import static org.ehcache.clustered.common.internal.messages.EhcacheEntityMessage.Type.RETIREMENT_OP;
...
public class EhcacheCodec implements MessageCodec<EhcacheEntityMessage, EhcacheEntityResponse> {
  ...
  private static final MessageCodec<EhcacheEntityMessage, EhcacheEntityResponse> SERVER_INSTANCE =
      new EhcacheCodec(new ServerStoreOpCodec(), new LifeCycleMessageCodec(), new StateRepositoryOpCodec(), new ResponseCodec(), new RetirementMessageCodec());
  ...
  private final RetirementMessageCodec retirementMessageCodec;
  ...
  EhcacheCodec(ServerStoreOpCodec serverStoreOpCodec, LifeCycleMessageCodec lifeCycleMessageCodec,
               StateRepositoryOpCodec stateRepositoryOpCodec, ResponseCodec responseCodec, RetirementMessageCodec retirementMessageCodec) {
    ...
    this.retirementMessageCodec = retirementMessageCodec;
  }
  ...
  public byte[] encodeMessage(EhcacheEntityMessage message) {
    switch (message.getType()) {
      ...
      case RETIREMENT_OP:
        return retirementMessageCodec.encode((RetirementMessage)message);
      default:
  ...
  public EhcacheEntityMessage decodeMessage(byte[] payload) throws MessageCodecException {
    ...
    } else if (opCode <= RETIREMENT_OP.getCode()) {
        return retirementMessageCodec.decode(payload);
    } else {
