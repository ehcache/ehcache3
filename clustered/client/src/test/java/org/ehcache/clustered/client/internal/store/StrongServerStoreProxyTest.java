...
public class StrongServerStoreProxyTest extends AbstractServerStoreProxyTest {
  ...
  public void testServerSideEvictionFiresInvalidations() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testServerSideEvictionFiresInvalidations", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, new ServerStoreProxy.InvalidationListener() {
      @Override
    ...
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testServerSideEvictionFiresInvalidations", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
  ...
  public void testHashInvalidationListenerWithAppend() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testHashInvalidationListenerWithAppend", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testHashInvalidationListenerWithAppend", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
  ...
  public void testConcurrentHashInvalidationListenerWithAppend() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testConcurrentHashInvalidationListenerWithAppend", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testConcurrentHashInvalidationListenerWithAppend", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
  ...
  public void testHashInvalidationListenerWithGetAndAppend() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testHashInvalidationListenerWithGetAndAppend", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testHashInvalidationListenerWithGetAndAppend", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        invalidatedHash.set(hash);
      }
  ...
  public void testAllInvalidationListener() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testAllInvalidationListener", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testAllInvalidationListener", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        throw new AssertionError("Should not be called");
      }
  ...
  public void testConcurrentAllInvalidationListener() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testConcurrentAllInvalidationListener", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testConcurrentAllInvalidationListener", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        throw new AssertionError("Should not be called");
      }
  ...
  public void testAppendInvalidationUnblockedByDisconnection() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testAppendInvalidationUnblockedByDisconnection", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testAppendInvalidationUnblockedByDisconnection", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
  ...
  public void testClearInvalidationUnblockedByDisconnection() throws Exception {
    ...
    StrongServerStoreProxy serverStoreProxy1 = new StrongServerStoreProxy("testClearInvalidationUnblockedByDisconnection", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, null);
    StrongServerStoreProxy serverStoreProxy2 = new StrongServerStoreProxy("testClearInvalidationUnblockedByDisconnection", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        throw new AssertionError("Should not be called");
      }
