...
public class EventualServerStoreProxyTest extends AbstractServerStoreProxyTest {
  ...
  public void testServerSideEvictionFiresInvalidations() throws Exception {
    ...
    EventualServerStoreProxy serverStoreProxy1 = new EventualServerStoreProxy("testServerSideEvictionFiresInvalidations", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, new ServerStoreProxy.InvalidationListener() {
      @Override
    ...
    EventualServerStoreProxy serverStoreProxy2 = new EventualServerStoreProxy("testServerSideEvictionFiresInvalidations", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
  ...
  public void testHashInvalidationListenerWithAppend() throws Exception {
    ...
    EventualServerStoreProxy serverStoreProxy1 = new EventualServerStoreProxy("testHashInvalidationListenerWithAppend", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
    ...
    EventualServerStoreProxy serverStoreProxy2 = new EventualServerStoreProxy("testServerSideEvictionFiresInvalidations", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, null);
  ...
  public void testHashInvalidationListenerWithGetAndAppend() throws Exception {
    ...
    EventualServerStoreProxy serverStoreProxy1 = new EventualServerStoreProxy("testHashInvalidationListenerWithGetAndAppend", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        invalidatedHash.set(hash);
        latch.countDown();
    ...
    EventualServerStoreProxy serverStoreProxy2 = new EventualServerStoreProxy("testHashInvalidationListenerWithGetAndAppend", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, null);
  ...
  public void testAllInvalidationListener() throws Exception {
    ...
    EventualServerStoreProxy serverStoreProxy1 = new EventualServerStoreProxy("testAllInvalidationListener", new ServerStoreMessageFactory(clientEntity1.getClientId()), clientEntity1, new ServerStoreProxy.InvalidationListener() {
      @Override
      public void onInvalidateHash(long hash) {
        throw new AssertionError("Should not be called");
      }
    ...
    EventualServerStoreProxy serverStoreProxy2 = new EventualServerStoreProxy("testAllInvalidationListener", new ServerStoreMessageFactory(clientEntity2.getClientId()), clientEntity2, null);
