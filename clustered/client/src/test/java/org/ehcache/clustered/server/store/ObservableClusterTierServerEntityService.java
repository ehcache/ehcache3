...
public class ObservableClusterTierServerEntityService
  ...
  public List<ObservableClusterTierActiveEntity> getServedActiveEntitiesFor(String name) {
    ...
    if (entities == null) {
      ...
      List<ObservableClusterTierActiveEntity> observables = new ArrayList<ObservableClusterTierActiveEntity>(entities.size());
  ...
  public List<ObservableClusterTierPassiveEntity> getServedPassiveEntitiesFor(String name) throws Exception {
    ...
    if (entities == null) {
      ...
      List<ObservableClusterTierPassiveEntity> observables = new ArrayList<ObservableClusterTierPassiveEntity>(entities.size());
  ...
  public ClusterTierActiveEntity createActiveEntity(ServiceRegistry registry, byte[] configuration) throws ConfigurationException {
    ...
    List<ClusterTierActiveEntity> existing = servedActiveEntities.putIfAbsent(c.getStoreIdentifier(), new ArrayList<ClusterTierActiveEntity>(singleton(activeEntity)));
    if (existing != null) {
  ...
  public ClusterTierPassiveEntity createPassiveEntity(ServiceRegistry registry, byte[] configuration) throws ConfigurationException {
    ...
    List<ClusterTierPassiveEntity> existing = servedPassiveEntities.putIfAbsent(c.getStoreIdentifier(), new ArrayList<ClusterTierPassiveEntity>(singleton(passiveEntity)));
    if (existing != null) {
