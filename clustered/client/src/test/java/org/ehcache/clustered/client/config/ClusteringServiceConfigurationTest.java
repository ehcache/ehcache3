...
public class ClusteringServiceConfigurationTest {
  ...
  public void testGetServersAndCacheManager() {
    assertThat(new ClusteringServiceConfiguration(SERVERS, CACHE_MANAGER).getServers()).isEqualTo(SERVERS);
    assertThat(new ClusteringServiceConfiguration(SERVERS, CACHE_MANAGER).getCacheManagerName()).isEqualTo(CACHE_MANAGER);
  }
