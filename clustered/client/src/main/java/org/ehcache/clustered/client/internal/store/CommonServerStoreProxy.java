...
//    entity.addResponseListener(ResolveRequest.class, new ResponseListener<ResolveRequest>() {
//      @Override
//      public void onResponse(ResolveRequest response) {
//        long key = response.getKey();
//
//        LOGGER.debug("CLIENT: performing server requested chain resolution {} (ID {})", cacheId, key);
//
//        Chain chain = response.getChain();
//        Chain compactedChain = resolver.resolveAll(chain, timeSource.getTimeMillis());
//        replaceAtHead(key, chain, compactedChain);
//      }
//    });
  }
