 ...
 */
public class ClusteredTierClientEntity implements Entity {

  private static final Logger LOGGER = LoggerFactory.getLogger(ClusteredTierClientEntity.class);
  ...
  ClusteredTierClientEntity(EntityClientEndpoint<EhcacheEntityMessage, EhcacheEntityResponse> endpoint) {
  ...
  EhcacheEntityResponse invoke(EhcacheEntityMessage message, boolean replicate)
  ...
  InvokeFuture<EhcacheEntityResponse> invokeAsync(EhcacheEntityMessage message, boolean replicate)
