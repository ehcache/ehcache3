...
if [ $is_major ]; then
  ...
  cp ehcache-xml/src/common/schema/ehcache-core.xsd $site_dir/schema/ehcache-core.xsd
  cp ehcache-xml/src/common/schema/ehcache-core.xsd $site_dir/schema/ehcache-core-${major_version}.xsd
