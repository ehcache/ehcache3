...
public class XAStoreTest {
  ...
  public void testSimpleGetPutRemove() throws Exception {
    ...
    OnHeapStore<Long, SoftLock<String>> onHeapStore = (OnHeapStore) new OnHeapStore<Long, SoftLock>(onHeapConfig, testTimeSource, keyCopier, valueCopier, new NoopSizeOfEngine());
