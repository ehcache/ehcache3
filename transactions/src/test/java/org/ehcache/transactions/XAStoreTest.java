...
public class XAStoreTest {
  ...
  public void testSimpleGetPutRemove() throws Exception {
    ...
    XAStore<Long, String> xaStore = new XAStore<Long, String>(Long.class, String.class, onHeapStore, defaultXAServiceProvider, testTimeSource, stateStore, uniqueXAResourceId, (Serializer) valueSerializer);
  ...
  public void testCompute() throws Exception {
    ...
    XAStore<Long, String> xaStore = new XAStore<Long, String>(Long.class, String.class, cacheStore, defaultXAServiceProvider, testTimeSource, stateStore, uniqueXAResourceId, (Serializer) valueSerializer);
