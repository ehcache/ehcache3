...
public class NonSharedHeapCachesTest {

  public static void main(String[] args) throws RunnerException {
    Options options = new OptionsBuilder()
      .include(NonSharedHeapCachesTest.class.getSimpleName())
      .forks(0)
      .build();
  ...
  public void setup() throws Exception {
    CacheManager manager = CacheManagerBuilder.newCacheManagerBuilder().sharedResources(
      ResourcePoolsBuilder.newResourcePoolsBuilder()).build(true);
    cache1 = manager.createCache("cache1",
      CacheConfigurationBuilder.newCacheConfigurationBuilder(Long.class, String.class,
        ResourcePoolsBuilder.newResourcePoolsBuilder().heap(100_000, EntryUnit.ENTRIES)));
