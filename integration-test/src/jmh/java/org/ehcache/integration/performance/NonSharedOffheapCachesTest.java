...
public class NonSharedOffheapCachesTest {

  public static void main(String[] args) throws RunnerException {
    Options options = new OptionsBuilder()
      .include(NonSharedOffheapCachesTest.class.getSimpleName())
      .forks(0)
      .build();
  ...
  public void setup() throws Exception {
    CacheManager manager = CacheManagerBuilder.newCacheManagerBuilder().sharedResources(
      ResourcePoolsBuilder.newResourcePoolsBuilder().offheap(64, MemoryUnit.MB)).build(true);
    cache1 = manager.createCache("cache1",
      CacheConfigurationBuilder.newCacheConfigurationBuilder(Long.class, String.class,
        ResourcePoolsBuilder.newResourcePoolsBuilder().heap(10_000, EntryUnit.ENTRIES).offheap(32, MemoryUnit.MB)));
