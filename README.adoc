...
We released 3.0.3 on August 5th, 2016.

The https://github.com/ehcache/ehcache3/releases/tag/v3.0.3[release notes] contain the links to the documentation to help you get started
