 ...
 * link:../milestones/107%20Alpha[107 Alpha] (on going): This is all the work to get a
 ...
 * link:../milestones/OSS%20Beta[OSS Beta] (coming up next): All the work to get all the features we want to port from
...
Additional tasks, as they come up, would only be targeted to the link:../milestones/107%20Alpha[107 Alpha] milestone,
only if implementing it would mean not being able to pass the 107 TCK. Any other task gets assigned to
link:../milestones/OSS%20Beta[OSS Beta].

See the link:../milestones[milestones on github] for more details on the current status.
