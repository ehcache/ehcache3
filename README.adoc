...
We released 3.8.0 on July 19th 2019.

The https://github.com/ehcache/ehcache3/releases/tag/v3.8.0[release notes] contain the links to the artifacts and the documentation to help you get started.
