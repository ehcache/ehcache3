...
/**
 * Test the {@link CachingTier#isExpired(Store.ValueHolder)} contract of the
...
public class CachingTierRemove<K, V> extends CachingTierTester<K, V> {
  ...
  public void removeMapping() {
    ...
    try {
      ...
      Store.ValueHolder newReturnedValueHolder = tier.getOrComputeIfAbsent(key, new Function() {
        @Override
      ...
      assertThat(newReturnedValueHolder, is(equalTo(newReturnedValueHolder)));
